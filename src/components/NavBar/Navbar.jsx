            ...
            <Row gutter={[24, 12]}>
                <Navbar bg="light" expand='lg' fixed='top'  expanded={expanded}>
                    ...
                    <Col xs={24} sm={10} md={10} lg={12} xl={12}>
                        <Row gutter={[24, 12]}><Col className={classes.tempCol2} xs={24}>
                            <Navbar.Toggle
                                onClick={() => setExpanded(expanded ? false : "expanded")} aria-controls="basic-navbar-nav"/>
                        </Col>
                        </Row>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav"   collapseOnSelect={true} >
                            <Nav >
                                <Nav.Link  onClick={() => setExpanded(false)} as={Link} to="home">STRONA GLÓWNA</Nav.Link>
                                <Nav.Link  onClick={() => setExpanded(false)} as={Link} to="aboutUs">O NAS</Nav.Link>
                                <Nav.Link  onClick={() => setExpanded(false)} as={Link} to="rooms">NOCLEGI/POKOJE</Nav.Link>
                                <Nav.Link  onClick={() => setExpanded(false)} as={Link} to="foto">GALERIA</Nav.Link>
                                <Nav.Link  onClick={() => setExpanded(false)} as={Link} to="kontakt">KONTAKT</Nav.Link>
                            </Nav>
                        </Navbar.Collapse>
                        </Col>
                        </Row>
